  ...
  render() {
    return (
      <MyMapComponent
        ...
        googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyD8i5EOy1YxaCCE2fT1PPsRKIElRspT1gY"
...
//   withProps({
//     googleMapURL:
//       "https://maps.googleapis.com/maps/api/js?key=AIzaSyD8i5EOy1YxaCCE2fT1PPsRKIElRspT1gY",
//     loadingElement: <div style={{ height: `100%` }} />,
